...
//
// Shared between `test/integration/vertical_slice_test.dart` (the pass/
// fail specification) and `tool/vertical_slice_report.dart` (a multi-seed
// report writer) — extracted here so neither duplicates this ~250-line
// gameplay sequence.
// ============================================================================
...
VerticalSliceOutcome runVerticalSlice(int seed) {
  final log = <String>[];
